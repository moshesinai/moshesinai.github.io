...
const WhyGuide = () => {
  const reasons = [
    ...
    },
    {
      ...
      description: "מלווה המשקיעים בוחן את העסקה מכל היבט - החל מסביבת הנכס, מצבו של הבניין, איכות השכנים, ועד למצב המשפטי, התכנוני והשמאי של הדירה. מדובר בעסקה ששווה הרבה מאוד כסף - ולכן נדרש מישהו שמבין לעומק."
    },
    {
      icon: TrendingUp,
